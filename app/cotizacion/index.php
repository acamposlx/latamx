...
?>
    ...
    <div class="rounded-corners clearfix grpelem" id="u567"><!-- column -->
      <div class="clearfix colelem" id="pu581-4"><!-- group -->
        ...
        <div class="rounded-corners grpelem" id="u593"><input type="text" class="form form-control" name="nombre" id="nombre" required="required" /></div>
      </div>
      <div class="clearfix colelem" id="pu587-4"><!-- group -->
        <div class="clearfix grpelem" id="u587-4"><!-- content -->
          <p>E-mail:</p>
        </div>
        <div class="rounded-corners grpelem" id="u596"><input name="email" type="text" class="form form-control" id="email" required="required" /></div>
      </div>
      <div class="clearfix colelem" id="pu590-4"><!-- group -->
        <div class="clearfix grpelem" id="u590-4"><!-- content -->
          <p>Teléfono de contacto</p>
        </div>
        <div class="rounded-corners grpelem" id="u599"><input name="telefono" type="text" class="form form-control" id="textfield" required="required" /></div>
      </div>
